...
import "../../css/home/searchResult.css";
...
const SearchResults = () => {
    ...
    useEffect(() => {
        if (query) {
            setCurrentPage(1)
            axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/searchProducts?keyword=${query}`)
    ...
    return (
        <div>
            <Helmet>
                ...
                <meta name="description" content={`Tìm thấy ${results.length} sản phẩm cho từ khóa "${query}"`} />
            </Helmet>
                                        ...
                                        <div className="price-sale">
                                            <div className="price-box">
                                                <span className="discounted-price">
                                                    {(
                                                        (rom?.price || 0) - (rom?.discountPrice || 0)
                                                    ).toLocaleString()}₫
                                                </span>
